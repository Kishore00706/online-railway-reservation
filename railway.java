...
class user {
    ...
    int check1(int tnum) throws Exception {
        ...
        Connection c = DriverManager
                .getConnection("jdbc:mysql://localhost:3306/railway?autoReconnect=true&useSSL=false", "root", "1234");
    ...
    int reserve(int tnum, String tname, String bp, String dp, int seat, int ch) {
        ...
        try {
            ...
            Connection c = DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/railway?autoReconnect=true&useSSL=false", "root", "1234");
            Statement s = c.createStatement();
...
class admin {
    ...
    void train_db(int tnum, String tname, int seats, String bp, String dp, int i, int j, int k, int l,
            java.sql.Date date, String dtime, String atime) {
        ...
        try {
            ...
            Connection c = DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/railway?autoReconnect=true&useSSL=false", "root", "1234");
            PreparedStatement st = c.prepareStatement(
                    "insert into train (tnum,tname,seats,bp,dp,fAC,sAC,tAC,sc,doj,dtime,atime) values(?,?,?,?,?,?,?,?,?,?,?,?)");
            st.setInt(1, tnum);
    ...
    void train_update_date() throws Exception {
        try {
            ...
            d = i.nextInt();
            PreparedStatement st = c.prepareStatement(
                    "update train set doj = DATE_ADD(doj, INTERVAL '" + d + "' DAY) where tnum='" + tnum + "' ");
            st.execute();
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    void setwR(int tnum, String str1, int seats, String str10, String str11, int fAc, int sAc, int tAc, int sc,
            java.util.Date doj, String str7, String str9, int width) {
        String str = Integer.toString(tnum);
        System.out.print(str);
        for (int x = str.length(); x < width; ++x)
            System.out.print(' ');
    ...
    void disp_train_db() {
        ...
        try {
            ...
            while (r.next()) {
                setwR(r.getInt(1), r.getString(2), r.getInt(3), r.getString(4), r.getString(5), r.getInt(6),
                        r.getInt(7), r.getInt(8), r.getInt(9), r.getDate(10), r.getString(11), r.getString(12), 15);
            }
    ...
    void setwR(long pnr, String str1, int age, String str3, int seats, String str5, String str6, Timestamp tm,
            java.util.Date dot, int width) {
    ...
    void disp_chart() throws Exception {
        try {
            ...
            System.out.println(
                    "***************************************************************************************************************************************************************************************");
            System.out.println(
                    "PNR Number          Name                Age                 Gender              Seat Number         Coach               Status              Booking time        Date of travelling");
            System.out.println(
                    "***************************************************************************************************************************************************************************************");
            Statement st = c.createStatement();
            ResultSet r = st.executeQuery("select * from chart where pnr>7999999999 and tnum='" + tn + "' ");
            while (r.next()) {
                setwR(r.getLong(1), r.getString(2), r.getInt(3), r.getString(4), r.getInt(5), r.getString(6),
                        r.getString(7), r.getTimestamp(8), r.getDate(9), 20);
            }
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    void disp_user() throws Exception {
        try {
            ...
            System.out.println(
                    "***************************************************************************************************************************************************************************************");
            System.out
                    .println("Username                 Age                      Gender                   Booking time");
            System.out.println(
                    "***************************************************************************************************************************************************************************************");
            Statement st = c.createStatement();
    ...
    void main_menu() throws Exception {
        ...
        switch (ch) {
            ...
            case 2:
                ...
                break;
            default:
                System.out.println("Made By Ayush Rai & Anshuman Mishra");
                System.exit(0);
                break;
